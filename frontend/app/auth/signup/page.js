...
const validationSchema = Yup.object().shape({
    ...
    password: Yup.string()
        ...
        .matches(
            /^(?=.*[A-Z])(?=.*[!@#$%^&*])(?=.*\d.*\d.*\d.*\d).*$/,
            "Password must contain at least one uppercase letter, one special character, and at least 4 digits"
        ),
                        ...
                        >
                            ...
                            <label className='form-control w-full max-w-lg'>
                                ...
                                <input
                                    type='file'
                                    name='avatar'
                                    className='file-input file-input-bordered w-full max-w-lg text-[#9BA3AF]'
                                />
                            </label>
