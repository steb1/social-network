...
const MainMessage = ({ AbletoTalk, Chatter, Sender, AvatarSender, Messages, Groups }) => {
                            ...
                            <div className='space-y-2 p-2 overflow-y-auto md:h-[calc(100vh-204px)] h-[calc(100vh-130px)]'>
                                {AbletoTalk &&
                                    AbletoTalk.map((user) => (
                                        <SideBarPreviewChat
                                            key={user.user_id}
                                            PrenomNom={`${user.first_name} ${user.last_name}`}
                                            avatar={user.avatar}
                                ...
                                {!AbletoTalk && !Groups && (
                                    <p className='text-justify font-bold'>
                                        No chatter available. Follow someone or wait for someone to follow you.
                                    </p>
                                )}
                            </div>
                        </div>
                            ...
                            <>
                                <div className='flex items-center justify-between gap-2 w- px-6 py-3.5 z-10 border-b dark:border-slate-700 uk-animation-slide-top-medium'>
                                    <div className='flex items-center sm:gap-4 gap-2'>
                                        ...
                                        >
                                            <img
                                                src={`http://localhost:8080/img/${Chatter[0].avatar}`}
                                                alt=''
