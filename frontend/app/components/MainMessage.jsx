            ...
            >
              <div className="p-4 border-b dark:border-slate-700">
                <div className="flex mt-2 items-center justify-between">
                  <h1 className="text-2xl font-bold text-black ml-1 dark:text-white">
                    {" "}
                    Chats{" "}
                  </h1>
                </div>
              ...
              <div className="space-y-2 p-2 overflow-y-auto md:h-[calc(100vh-204px)] h-[calc(100vh-130px)]">
                {messagesPreview &&
                  messagesPreview.map((user) => {
                    if (user.genre === "group") {
                      const groupToFetch = Groups.find(
                        (group) => group.GroupID == user.nickname
                      );
                ...
                {!AbletoTalk && !Groups && (
                  <p className="text-justify font-bold">
                    No chatter available. Follow someone or wait for someone to
                    follow you.
                  </p>
                )}
              </div>
              ...
              <>
                ...
                <div className="w-full p-5 py-10 overflow-y-auto md:h-full h-screen">
                  ...
                  <div
                    id="cms"
                    ref={cmsRef}
                    className="text-sm font-medium space-y-6 h-[50vh]"
                  ></div>
                </div>
              </>
            ) : (
                ...
                <div className="w-full p-5 py-10 overflow-y-auto md:h-[calc(100vh-204px)] h-[calc(100vh-195px)]">
                  <div className="py-10 text-center text-sm lg:pt-8">
                    ...
                    <div className="mt-3.5">
                      {Chatter && Chatter[0] && (
                        <Link
                          href={`/profile/${Chatter[0].user_id}`}
                  ...
                  <div
                    id="cms"
                    ref={cmsRef}
                    className="text-sm font-medium space-y-6"
                  >
                    {Chatter && Chatter.length
                      ? messages &&
                ...
                <div className="flex items-center md:gap-4 gap-2 md:p-3 p-2 overflow-hidden">
                  ...
                  <div className="relative flex-1">
                    ...
                    <button
                      ...
                      className="text-black dark:text-white shrink-0 p-2 absolute right-0.5 top-0"
                    >
                      <ion-icon
                  ...
                  {Chatter && Chatter[0] && (
                    <>
                      <div className="py-10 text-center text-sm pt-20">
                        <img
                          src={`${config.ServerApiImage}${Chatter[0].avatar}`}
                          className="w-24 h-24 rounded-full mx-auto mb-3"
                          alt=""
                        />
                        <div className="mt-8">
