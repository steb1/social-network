            ...
            <div className='max-w-[1220px] mx-auto flex items-center'>
                <div className='flex items-center sm:gap-4 gap-2 absolute right-5 top-1/2 -translate-y-1/2 text-black'>
                    ...
                    >
                        ...
                        <div class='absolute top-0 right-0 -m-1 bg-red-600 text-white text-xs px-1 rounded-full'>3</div>
                    </button>
                    <div
                        ...
                        <div class='h-80 overflow-y-auto pr-2'>
                            {messagesPreview &&
                                messagesPreview.map((user) => (
                                    <div key={user.nickname} class='p-2 pt-0 pr-1 dark:te xt-white/80'>
                                        <Link
