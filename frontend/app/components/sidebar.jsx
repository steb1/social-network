...
const Sidebar = async () => {
  ...
  return (
    <div
      id="site__sidebar"
      className="fixed top-0 left-0 z-[99] pt-[--m-top] overflow-hidden transition-transform xl:duration-500 max-xl:w-full max-lg:-translate-x-full"
    >
        ...
        <div className="pr-6 pt-10" data-simplebar>
          <nav id="side">
            <ul className="grid gap-y-5">
              ...
              <li className="dark:hover:text-slate-800">
                <Link
                  href={`/messages/${user?.nickname ? user.nickname : user.email}`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    width="32"
      ...
      <div
        ...
        className="absolute top-0 left-0 z-20 w-screen h-screen sm:hidden backdrop-blur-sm"
