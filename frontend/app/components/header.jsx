const Header = () => {
    return (
        <header className='z-[100] h-[--m-top]  block mr-20 top-0 left-0 w-full flex items-center bg-white/80 sky-50 backdrop-blur-xl border-b border-slate-200 dark:bg-dark2 dark:border-slate-800'>
                        ...
                        >
                            <div className='xl:w-[694px] sm:w-96 bg-white dark:bg-dark3 w-screen p-2 rounded-lg shadow-lg -mt-14 pt-14'>
                                ...
                                <nav className='text-sm font-medium text-black dark:text-white'>
                                    ...
                                    >
                                        {" "}
                                        <ion-icon className='text-2xl' name='search-outline' /> Creative ideas about
                                        Business
                                    </a>
                                    <a
                                        href='#'
                                    ...
                                    <div className='pl-2 p-1 text-sm font-normal dark:text-white'>
                                        ...
                                        >
                                            ...
                                            <div className='flex-1 '>
                                                <p>
                                                    {" "}
                                                    <b className='font-bold mr-1'>Jesse Steeve</b> mentioned you in a
                                                    story. Check it out and reply. 📣{" "}
                                                </p>
                                                <div className='text-xs text-gray-500 mt-1.5 dark:text-white/80'>
                                                    {" "}
                                                    8 hours ago{" "}
                                        ...
                                        >
                                            ...
                                            <div className='flex-1 '>
                                                <p>
                                                    {" "}
                                                    <b className='font-bold mr-1'> Alexa stella</b> commented on your
                                                    photo “Wow, stunning shot!” 💬{" "}
                                                </p>
                                                <div className='text-xs text-gray-500 mt-1.5 dark:text-white/80'>
                                                    {" "}
                                                    8 hours ago{" "}
                                        ...
                                        >
                                            ...
                                            <div className='flex-1 '>
                                                <p>
                                                    {" "}
                                                    <b className='font-bold mr-1'> Lewis Lewis</b> mentioned you in a
                                                    story. Check it out and reply. 📣{" "}
                                                </p>
                                                <div className='text-xs text-gray-500 mt-1.5 dark:text-white/80'>
                                                    {" "}
                                        ...
                                        >
                                            ...
                                            <div className='flex-1 '>
                                                <p>
                                                    {" "}
                                                    <b className='font-bold mr-1'> Martin Gray</b> liked your photo of
                                                    the Eiffel Tower. 😍{" "}
                                                </p>
                                                <div className='text-xs text-gray-500 mt-1.5 dark:text-white/80'>
                                                    {" "}
