...
export const CreateGroup = () => {
	...
	return (
		<Link href="" className="dark:hover:text-slate-800">
			...
			<li onClick={() => document.getElementById("my_modal_3").showModal()} className="dark:hover:text-slate-800" uk-scrollspy-class="uk-animation-fade">
