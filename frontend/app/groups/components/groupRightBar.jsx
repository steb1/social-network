export const GroupRightBar = (groupId, invites, setInvites, members, groupInfo ) => {
    return (
        <div className="w-[400px]" uk-sticky=""> 
            <div className=" flex flex-col gap-5">
                ...
                <ul className="text-gray-700 space-y-4 mt-2 mb-1 text-sm dark:text-white">
                    <li> { groupInfo ? groupInfo.description : "gggg" } </li>
                    ...
                    <div> 
                        <span className="font-semibold text-black dark:text-white">Public</span> 
                    ...
                    <div>  Members <span className="font-semibold text-black dark:text-white"> 3,240 People </span> </div>
                    </li>
                </ul>
                </div>
                {/* group media  */}
