        ...
        <div className="w-[400px]" uk-sticky=""> 
            <div className=" flex flex-col gap-5">
                ...
                <ul className="text-gray-700 space-y-4 mt-2 mb-1 text-sm dark:text-white">
                    ...
                    <div>  Members <span className="font-semibold text-black dark:text-white"> { members ? members.length : "" } People </span> </div>
                    </li>
                </ul>
                </div>
                ...
                <div className="side-list mb-10">
                    ...
                    <a href="timeline-group.html">
                        <img src="../assets/images/avatars/avatar-5.jpg" alt="" className="side-list-image w-9 h-9 rounded-full" />
                    </a>
                    <div className="flex-1">
                        <a href="timeline-group.html"><h4 className="side-list-title"> { `${invites.first_name} ${invites.last_name}`} </h4></a>
                    </div>
                    <button onClick={(e) => handleInviteUsers(e, groupId, invites.user_id, setInvites)} className="button bg-primary text-white">Invite</button>
                    </div>
                    ) : "" }
