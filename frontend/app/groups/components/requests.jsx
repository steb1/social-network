        ...
        <div className="flex flex-row gap-2">
            <div className="flex flex-row h-16  dark:bg-slate-800 px-1 bg-white gap-3 w-[30rem] border-2 items-center rounded-2xl ">
                ...
                <div className=" flex right-0 gap-2 justify-self-end ">
                    <button id={ request.user_id ? request.user_id : ""} onClick={ (e) => handleRequest(e, "accept", request.user_id) } className="flex flex-row w-16 h-16 px-1 my-auto	 gap-3  items-center rounded-full">
            ...
            <div className="flex flex-row w-10 h-10 px-1 my-auto gap-3  items-center rounded-full" >
                <button  onClick={ (e) => handleRequest(e, "reject", request.user_id) } className="hover:bg-slate-100">
