        ...
        <div className="flex flex-row gap-2">
            <div className="flex flex-row h-16 px-1 bg-white gap-3 w-[30rem] border-2 items-center rounded-2xl ">
                ...
                <div className=" flex right-0 gap-2 justify-self-end ">
                    <button id={ request.user_id ? request.user_id : ""} onClick={ (e) => handleRequest(e, setPosts, setGroup, setEvents, setRequests, setMessages, setServerError, groupId, "accept", request.user_id, setIsowner, setMembers) } className="flex flex-row w-16 h-16  px-1 my-auto	 gap-3  items-center rounded-full">
